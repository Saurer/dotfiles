  ...
  (setq-default
   ...
   '(
     ...
     (tabs :variables
           ...
           tabs-show-navigation-buttons 0
           tabs-set-bar 'left
           tabs-close-button nil
           )
     git
     helm
     (lsp :variables
...
It should only modify the values of Spacemacs settings."
  ...
  (setq-default
   ...
   dotspacemacs-themes '(omtose-darker spacemacs-dark
                         spacemacs-light)
...
before packages are loaded."
  ...
  ;; Add ESLint to TypeScript TSX mode
